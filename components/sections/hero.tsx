...
export default function HeroSection() {
    ...
    return (
        <section className="relative overflow-hidden">
            <div className="absoulte inset-0 bg-gradient-to-br from-primary/4 to-secondary/7">
                    ...
                    <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px] p-10">
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-2 md:flex-row'>
                                ...
                                <Button size='lg' variant={`outline`} type='button' onClick={() => router.push(`/startup/create`)}>
                                    Create One
